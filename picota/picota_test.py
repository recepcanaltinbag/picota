...
out_dir = "/media/lin-bio/back2/picota_assembly/sra_files" + "/" + sra_acc_file
sra_folder = "/media/lin-bio/back2/picota_assembly/sra_files"
...
raw_file_list = [os.path.join(sra_folder, sra_acc_file, f"{sra_acc_file}_{i}.fastq") for i in (1, 2)]
main_out_folder = os.path.join("/media/lin-bio/back2/picota_assembly",sra_acc_file)
assembly_threads = 24
...
#Kullanılacak çıktı path_to_data = "/media/lin-bio/back2/picota_assembly/{sra_acc_file}/*.gfa içinden almalı

path_to_data = "/media/lin-bio/back2/picota_assembly/gfa_files/best_gfa/k119.gfa"
find_all_path = True
path_limit = 25
out_cycle_file = "/media/lin-bio/back2/picota_assembly/test_cycle/{sra_acc_file} + naem of gfa file .fasta"
...
scoring_main(cycle_file, scoring_out_folder, path_to_antibiotics, path_to_xenobiotics, path_to_ises)
